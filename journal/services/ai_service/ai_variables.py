...
SYSTEM_MESSAGE = f"""
    ...
    Emotions (use only these, 0–{MAX_EMOTIONS} max): {EMOTIONS}
    ...
    Output:
    {{"summary": "Today felt heavy for you — the focus just wasn't there and everything seemed to drag. But you still carved out that walk in the evening, and it sounds like it made a real difference.", "emotions": [{{"name": "fatigue", "confidence": 0.85}}, {{"name": "calm", "confidence": 0.40}}], "recommendations": "Tomorrow, try starting with just one small task instead of the full list. A short walk worked today — keep that in your toolkit."}}
